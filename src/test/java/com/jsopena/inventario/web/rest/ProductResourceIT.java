...
public class ProductResourceIT {
    ...
    private static final Ubicacion DEFAULT_UBICACION = Ubicacion.CAJA_BLANCA;
    private static final Ubicacion UPDATED_UBICACION = Ubicacion.TRASTERO;
    ...
    public void createProduct() throws Exception {
        ...
        assertThat(testProduct.getCantidad()).isEqualTo(DEFAULT_CANTIDAD);
        assertThat(testProduct.getUbicacion()).isEqualTo(DEFAULT_UBICACION);
        assertThat(testProduct.getImage1()).isEqualTo(DEFAULT_IMAGE_1);
        assertThat(testProduct.getImage1ContentType()).isEqualTo(DEFAULT_IMAGE_1_CONTENT_TYPE);
        assertThat(testProduct.getImage2()).isEqualTo(DEFAULT_IMAGE_2);
        assertThat(testProduct.getImage2ContentType()).isEqualTo(DEFAULT_IMAGE_2_CONTENT_TYPE);
    }
    ...
    public void updateProduct() throws Exception {
        ...
        assertThat(testProduct.getCantidad()).isEqualTo(UPDATED_CANTIDAD);
        assertThat(testProduct.getUbicacion()).isEqualTo(UPDATED_UBICACION);
        assertThat(testProduct.getImage1()).isEqualTo(UPDATED_IMAGE_1);
        assertThat(testProduct.getImage1ContentType()).isEqualTo(UPDATED_IMAGE_1_CONTENT_TYPE);
        assertThat(testProduct.getImage2()).isEqualTo(UPDATED_IMAGE_2);
        assertThat(testProduct.getImage2ContentType()).isEqualTo(UPDATED_IMAGE_2_CONTENT_TYPE);
    }
