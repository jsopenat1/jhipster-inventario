...
describe('Product e2e test', () => {
  ...
  /* it('should create and save Products', async () => {
        ...
        expect(await productUpdatePage.getImage1Input()).to.endsWith(fileNameToUpload, 'Expected Image1 value to be end with ' + fileNameToUpload);
        expect(await productUpdatePage.getImage2Input()).to.endsWith(fileNameToUpload, 'Expected Image2 value to be end with ' + fileNameToUpload);
  ...
  /* it('should delete last Product', async () => {
        ...
        expect(await productDeleteDialog.getDialogTitle())
            .to.eq('inventarioApp.product.delete.question');
