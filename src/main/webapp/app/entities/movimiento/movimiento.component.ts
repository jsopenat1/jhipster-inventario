...
export class MovimientoComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.movimientoService
      ...
      .subscribe(
        (res: HttpResponse<IMovimiento[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInMovimientos(): void {
    this.eventSubscriber = this.eventManager.subscribe('movimientoListModification', () => this.loadPage());
  }
